...
- make run-seq > roda o sequencial
- make clean  	> apaga os binarios locais

*dentro do make temos um campo para colocar o tempo do codigo sequencial, para entregar o calculo de eficiencia
